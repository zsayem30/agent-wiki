...
| Record or review a handoff | `agent-wiki/knowledge/change_inbox.jsonl` | changed files, suggested routes, source reports |
...
| Configure host OpenCode | `agent-wiki/templates/project-root/opencode.json` | host `opencode.json`, `.opencode/README.md` |
